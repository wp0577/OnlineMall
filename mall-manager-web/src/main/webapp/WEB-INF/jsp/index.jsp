...
<title>wp-mall backstage manager system</title>
    	...
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 5px;">
         	<li>
         		...
         		<ul>
	         		...
	         		<li data-options="attributes:{'url':'item-param-list'}">Item Spec</li>
	         	</ul>
         	</li>
         	<li>
         		<span>Mall Content Management</span>
         		<ul>
	         		<li data-options="attributes:{'url':'content-category'}">Classify by Content </li>
	         		<li data-options="attributes:{'url':'content'}">Content Management</li>
	         	</ul>
         	</li>
         	<li>
         		<span>索引库管理</span>
